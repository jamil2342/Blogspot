...
#ifndef __SharePointCollector_h__
#define __SharePointCollector_h__
...
#ifndef __ISharePointCollect_FWD_DEFINED__
#define __ISharePointCollect_FWD_DEFINED__
typedef interface ISharePointCollect ISharePointCollect;

#endif 	/* __ISharePointCollect_FWD_DEFINED__ */


#ifndef __SharePointCollect_FWD_DEFINED__
#define __SharePointCollect_FWD_DEFINED__

#ifdef __cplusplus
typedef class SharePointCollect SharePointCollect;
#else
typedef struct SharePointCollect SharePointCollect;
#endif /* __cplusplus */

#endif 	/* __SharePointCollect_FWD_DEFINED__ */
...
#ifndef __ISharePointCollect_INTERFACE_DEFINED__
#define __ISharePointCollect_INTERFACE_DEFINED__

/* interface ISharePointCollect */
/* [unique][helpstring][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_ISharePointCollect;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("7A40C4C5-77F1-4350-A59D-854CEAA22F32")
    ISharePointCollect : public IDispatch
    {
    public:
    };
    ...
    typedef struct ISharePointCollectVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            ISharePointCollect * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        END_INTERFACE
    } ISharePointCollectVtbl;

    interface ISharePointCollect
    {
        CONST_VTBL struct ISharePointCollectVtbl *lpVtbl;
    };
...
#define ISharePointCollect_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ISharePointCollect_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ISharePointCollect_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ISharePointCollect_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define ISharePointCollect_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define ISharePointCollect_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define ISharePointCollect_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* __ISharePointCollect_INTERFACE_DEFINED__ */



#ifndef __SharePointCollectorLib_LIBRARY_DEFINED__
#define __SharePointCollectorLib_LIBRARY_DEFINED__

/* library SharePointCollectorLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_SharePointCollectorLib;

EXTERN_C const CLSID CLSID_SharePointCollect;

#ifdef __cplusplus

class DECLSPEC_UUID("16B172C2-8025-4E85-A636-90EF654A115A")
SharePointCollect;
#endif
#endif /* __SharePointCollectorLib_LIBRARY_DEFINED__ */
