...
class ATL_NO_VTABLE CCollectorCollect :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CCollectorCollect, &CLSID_SharePointCollect>,
...
public:
	CCollectorCollect();
	virtual ~CCollectorCollect();

DECLARE_REGISTRY_RESOURCEID(IDR_SHAREPOINTCOLLECT)
DECLARE_NOT_AGGREGATABLE(CCollectorCollect)

BEGIN_COM_MAP(CCollectorCollect)
...
public:
	...
	ICollectorAdapter *m_pFastMoney;
	bool m_bErrorIssued;
...
OBJECT_ENTRY_AUTO(__uuidof(SharePointCollect), CCollectorCollect)
